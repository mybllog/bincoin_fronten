...
import {Lock,AccountBoxSharp} from '@mui/icons-material';
      ...
      <div className=" py-40">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 w-full">
          ...
          <div className="flex flex-col justify-center text-center md:text-left">
            ...
            <Button className="bg-green-300 to-lime-700 hover:bg-green-400 w-48 md:w-60 h-10 text-lg md:text-xl font-bold text-black"><NavLink to="/signup">LOGIN/REGISTER</NavLink></Button>
